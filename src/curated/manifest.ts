...
export const curatedSounds: CuratedSound[] = [
  ...
  kenney("weapons", "laser-small-2", "Laser, small (alt)", 244, KENNEY_SCIFI,
    "A sibling zap from the same Kenney pack — same spectral family as laser-small but slightly longer decay tail; hear how a few milliseconds of sustain shifts the perceived energy."),
  {
    id: "weapons.pistol-shot",
    name: "Pistol shot",
    setId: "weapons",
    file: "curated/weapons/pistol-shot.wav",
    durMs: 2131,
    source: "https://opengameart.org/content/gunshots",
    author: "kurt",
    license: "CC0-1.0",
    attributionRequired: false,
    note: "Actual .22 caliber pistol recorded at a range — the sharp crack and room reverb tail are what all designed gun sounds are trying to evoke; compare against the sci-fi lasers above to hear how far the design departs from the real event.",
  },
  {
    id: "weapons.mag-reload",
    name: "Magazine reload",
    setId: "weapons",
    file: "curated/weapons/mag-reload.wav",
    durMs: 209,
    source: "https://opengameart.org/content/gun-reload-sound-effects",
    author: "BMacZero",
    license: "CC0-1.0",
    attributionRequired: false,
    note: "A real magazine clip seating into a pistol grip — 209ms of mechanical action that communicates 'ready to fire' before any shot is heard; the metal-on-plastic snap is the entire cue.",
  },
  {
    id: "weapons.shotgun-fire",
    name: "Shotgun, double barrel",
    setId: "weapons",
    file: "curated/weapons/shotgun-fire.wav",
    durMs: 418,
    source: "https://opengameart.org/content/toy-double-barrel-shotgun-sounds",
    author: "JumboSizedFish",
    license: "CC0-1.0",
    attributionRequired: false,
    note: "Toy double-barrel shotgun firing both chambers — even at toy scale the staggered transient pair reads as 'double' without needing real powder; the mechanism communicates the weapon type.",
  },
  ...
  {
    id: "engines.fan-motor",
    name: "Motor, defective fan",
    setId: "engines",
    file: "curated/engines/fan-motor.wav",
    durMs: 3011,
    source: "https://opengameart.org/content/defect-motor-loop",
    author: "qubodup",
    license: "CC0-1.0",
    attributionRequired: false,
    note: "A real PC cooling fan running with a bearing defect — the irregular amplitude flutter is the acoustic fingerprint of mechanical wear, not synthesis.",
  },
  {
    id: "engines.car-engine",
    name: "Car engine, idle",
    setId: "engines",
    file: "curated/engines/car-engine.wav",
    durMs: 2966,
    source: "https://opengameart.org/content/car-sound-effects-pack-low-quality",
    author: "GGBotNet",
    license: "CC0-1.0",
    attributionRequired: false,
    note: "Recorded car idle loop from a mobile phone — low-fidelity capture is itself informative: hear how the combustion pulse train survives even at 64 kb/s.",
  },
